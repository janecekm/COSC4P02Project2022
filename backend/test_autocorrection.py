...
def testing_spelling_mistake():
    ...
    assert correcting_english("hello there, how is it going?") == "hello there how is it going"
    assert correcting_english("wht are prere for Math 4p61") == "what are prereq for math 4p61"
